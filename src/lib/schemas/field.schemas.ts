...
export const fieldSchema = z.object({
    ...
    label: z
        ...
        .regex(/^[a-zA-Z0-9\s\-_]+$/, 'Field label can only contain letters, numbers, spaces, hyphens, and underscores'),
    description: z
        .string()
        .trim()
 ...
 */
export const fieldsListSchema = z.array(fieldSchema).refine(
    (fields) => {
 ...
 */
export const fieldWithTemplateSchema = z.object({
    field: fieldSchema,
